-- ====================================================================
-- CropPilot AI - PostgreSQL Database Schema with Row Level Security (RLS)
-- Migration File: 20260804_croppilot_ai_schema.sql
-- ====================================================================

-- 0. Enable UUID extension if not enabled
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 1. Create Farmers / Profiles Table (Linked to Auth.Users)
...
-- 5. Create Crop Advisories Table (AI Generated Recommendations)
...
-- 5. Crop Advisories RLS Policies
...
-- ====================================================================
-- Automated Updated-At Timestamp Triggers
-- ====================================================================
